...
export const TravelSafetyPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-16 animate-in fade-in duration-300 max-w-6xl mx-auto">
        ...
        <div className="flex items-start md:items-center gap-4 z-10">
          ...
          <div>
            ...
            <h1 className="font-serif text-2xl lg:text-3xl font-bold text-gray-900 dark:text-rose-100 mt-1">
              Pregnancy Travel Safety & Relocation Studio
            </h1>
            <p className="text-xs lg:text-sm text-gray-600 dark:text-rose-200 mt-1 max-w-xl">
              Week {currentWeek} · Airline policy checker (IndiGo, Air India, Akasa), printable Fit-to-Fly certificate, DVT circulation coach, and transfer dossier.
            </p>
          </div>
        </div>
      ...
      <div className="pastel-sky-card p-6 rounded-3xl border border-sky-200/50 shadow-sm space-y-5">
