    ...
    <div className="min-h-screen text-gray-900 dark:text-rose-100 pb-24 pt-2 space-y-6 font-sans max-w-7xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="pink-cream-card rounded-3xl p-6 border border-[#f3dbe2] dark:border-rose-900/30 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 shadow-sm hover:shadow-md transition-all">
        <div className="flex items-start gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-rose-500 via-pink-400 to-[#e26989] text-white flex items-center justify-center shrink-0 shadow-md shadow-rose-500/20">
            <Sparkles className="w-7 h-7 animate-pulse" />
          </div>
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-1">
              <span className="text-[10px] font-extrabold uppercase tracking-widest bg-rose-100 dark:bg-rose-950/70 text-[#8f2d48] dark:text-rose-300 px-2.5 py-0.5 rounded-full border border-rose-200 dark:border-rose-800/40">
            ...
            <h3 className="text-base sm:text-lg font-bold text-[#681e35] dark:text-rose-100 font-serif">
              My Maternal Digital Twin
            </h3>
            <p className="text-xs text-gray-600 dark:text-rose-200/80 mt-0.5 max-w-xl leading-relaxed">
        ...
        <button
          ...
          className="px-6 py-3 rounded-2xl bg-gradient-to-r from-rose-500 to-[#e26989] hover:from-rose-600 hover:to-[#d65778] text-white font-bold text-xs shadow-md shadow-rose-500/25 transition-all flex items-center gap-2 shrink-0 cursor-pointer hover:scale-105"
        >
